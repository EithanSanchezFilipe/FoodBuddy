...
async function handleGoogleSignIn() {
  ...
  if (success) {
    // Redirect is handled by the provider callback
  }
}
</script>
...
<template>
  <div class="auth-page">
    <div class="auth-container">
      <h1>Sign Up</h1>
      <p class="subtitle">Join FoodBuddy today</p>
      ...
      <form @submit.prevent="handleSignUp" class="auth-form">
        ...
        <div class="form-group">
          ...
          <input
            ...
            required
          />
          <span v-if="!passwordsMatch" class="error-text"> Passwords do not match </span>
        </div>
        <button type="submit" class="btn-primary" :disabled="authStore.isLoading || !isFormValid">
